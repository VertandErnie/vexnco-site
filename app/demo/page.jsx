export default function DemoPage() {
  return (
    <section className="relative min-h-screen bg-black">
      ...
      <div className="relative max-w-[1200px] mx-auto px-4 pt-24 pb-32">
        {/* Header */}
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-3">
            <div className="ve-dot" />
            <span className="ve-section-label">Operational Physics — Visual Shell</span>
          </div>
          ...
          <p className="mt-3 max-w-2xl text-frost/70">
            This is a visual prototype of how VE thinks about work as a moving system.
            It is not a finished product — it is a behavioral surface.
          </p>
        </div>
